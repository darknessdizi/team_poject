...
def main():
    ...
    conn = psycopg2.connect(dbname="team_project", user="postgres",
                            password="")
            ...
            for event in longpoll.listen():
                ...
                if event.type == VkEventType.MESSAGE_NEW:
                    ...
                    if event.to_me:
                        ...
                        if event.text == "Начинаем поиск":
                        ...
                        elif event.text in ['Список избранных']:
                            if base.get_favourites(cur, variables['id']):
                                ...
                                continue
############  20:15 ниже с кодом работаю !!!
                        # elif event.text in ['поиск']:
                        #     print(ask_user)
                        #     bot.write_msg(vk, variables['id'], f"Поиск...")
                        #     if not base.get_favourites(cur, variables['id']):
                        ...
                        #                     message = f"{element.get('first_name')}  {element.get('first_name')} \n 'https://vk.com/id{element.get('id')}'"
                        #                     bot.write_msg(vk, message=message)
                        ...
                        # #
                        #
                        # elif event.text.lower().strip() in ['Смотретьданные']:
                        ...
                        #     if base.add_favourites(cur, result[counter - 1]['id'], variables['id'],
                        #                            result[counter - 1]['user_name'],
                        ...
                        # else:
                        #     print('Ошибка')
                # Если не новое сообщение
        #         else:
        #             bot.write_msg(vk, variables['id'], "Смотреть данные")
        # #
        # #
        #             if event.text.lower().strip() in ['Смотреть данные']:#elif event.text.lower().strip() in ['Смотреть данные']:
        # #
        #                 if base.check_find_user(cur, ask_user[0]):
        #                     counter = add_to_database(cur, variables['id'], result)
        #                 else:
        ...
        #                 bot.write_msg(vk, variables['id'], "Добавлен в чёрный список")
        #
        # conn.close()  # 16:30 убрала низ кода, тестируем верхнюю часть
        # else:
